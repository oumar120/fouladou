...
<div class="super_container">
  ...
  <div class="search">
          ...
          <div class="search_form_container">
            <form action="recherche.php" class="search_form" id="search_form" method="get">
              <div class="d-flex flex-md-row flex-column align-items-center justify-content-between">
                <input type="text" class="search_input col-lg-8" required="required" name="search">
    ...
    if (!empty($_GET['p'])) {
      ...
      if ($page==1) {
     $req=$bdd->query('select * from music order by id desc limit 10,10');
      if ($req->rowCount()==0) {
  ...
  <div class="jp-jplayer jplayer" data-title="<?php echo $donnee['nom'];?>&nbsp;<strong class='d-none d-sm-inline'><?php echo $donnee['titre'] ; ?></strong>" data-artist="<?php echo $donnee['titre'] ; ?>" data-ancestor=".<?php echo $donnee['id'] ; ?>" 
    ...
    <?php }}
      ...
      $req=$bdd->query('select * from music order by id desc limit 20,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
  ...
  <div class="jp-jplayer jplayer" data-title="<?php echo $donnee['nom'];?>&nbsp;<strong class='d-none d-sm-inline'><?php echo $donnee['titre'] ; ?></strong>" data-artist="<?php echo $donnee['titre'] ; ?>" data-ancestor=".<?php echo $donnee['id'] ; ?>" 
   ...
   <?php  }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 30,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
  ...
  <div class="jp-jplayer jplayer" data-title="<?php echo $donnee['nom'];?>&nbsp;<strong class='d-none d-sm-inline'><?php echo $donnee['titre'] ; ?></strong>" data-artist="<?php echo $donnee['titre'] ; ?>" data-ancestor=".<?php echo $donnee['id'] ; ?>" 
    ...
    <?php }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 40,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
  ...
  <div class="jp-jplayer jplayer" data-title="<?php echo $donnee['nom'];?>&nbsp;<strong class='d-none d-sm-inline'><?php echo $donnee['titre'] ; ?></strong>" data-artist="<?php echo $donnee['titre'] ; ?>" data-ancestor=".<?php echo $donnee['id'] ; ?>" 
    ...
    <?php }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 50,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
...
<?php }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 60,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
  ...
  <?php }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 70,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
  ...
  <div class="jp-jplayer jplayer" data-title="<?php echo $donnee['nom'];?>&nbsp;<strong class='d-none d-sm-inline'><?php echo $donnee['titre'] ; ?></strong>" data-artist="<?php echo $donnee['titre'] ; ?>" data-ancestor=".<?php echo $donnee['id'] ; ?>" 
    ...
    <?php }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 80,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
  ...
  <div class="jp-jplayer jplayer" data-title="<?php echo $donnee['nom'];?>&nbsp;<strong class='d-none d-sm-inline'><?php echo $donnee['titre'] ; ?></strong>" data-artist="<?php echo $donnee['titre'] ; ?>" data-ancestor=".<?php echo $donnee['id'] ; ?>" 
    ...
    <?php }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 90,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
  ...
  <div class="jp-jplayer jplayer" data-title="<?php echo $donnee['nom'];?>&nbsp;<strong class='d-none d-sm-inline'><?php echo $donnee['titre'] ; ?></strong>" data-artist="<?php echo $donnee['titre'] ; ?>" data-ancestor=".<?php echo $donnee['id'] ; ?>" 
    ...
    <?php }}
       ...
       $req=$bdd->query('select * from music  order by id desc limit 100,10');
      if ($req->rowCount()==0) {
       echo "<h2 style='text-align:center'>pas de contenu pour cette page!</h2>";
     }
     while ($donnee=$req->fetch()){
